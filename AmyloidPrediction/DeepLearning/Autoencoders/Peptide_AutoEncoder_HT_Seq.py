...
if __name__ == "__main__":
    ...
    training_set = "PeptideManifoldWithOneHotFeatures_Split.csv"
    val_set = "Val_Seq"
    test_set = "Test_Seq"
    ...
    pickle.dump(study, open('Seq_Study','wb'))
    pickle.dump(best_params, open('best_params_autoencoder_Seq.sav', 'wb'))

    with open("best_params_autoencoder_Seq.sav","rb") as f:
    ...
    autoencoder.save("Best_HT_Autoencoder_Seq.model")
    encoder_model.save("Best_HT_Encoder_Seq.model")
    ...
    with open("Training_Set_Embeddings_Seq.pickle", 'wb') as f:
        pickle.dump(train_comp,f)

    with open("Validation_Set_Embeddings_Seq.pickle", 'wb') as f:
        pickle.dump(val_comp,f)

    with open("Testing_Set_Embeddings_Seq.pickle", 'wb') as f:
